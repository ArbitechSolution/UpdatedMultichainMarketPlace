...
function init() {
	...
	switch (Number(chainIdSaved)) {
		...
		case CHAIN_ARBI_TEST:
			...
			break;
		case CHAIN_POLY_TEST:
			rpcOption = {
				80001: CHAIN_INFO[CHAIN_ARBI_TEST].rpcUrls[0],
			};
			break;
...
const Header = (props) => {
	...
	return (
		<header id="header_main" className="header_1 js-header" ref={headerRef}>
										...
										{menus.map((data, index) => (
											<li
												...
												className={`menu-item ${
													...
													data.id == 6 ? 'menu-item-chain' : ''
												}`}
											>
												<Link to={data.links}>
													{data.id == 6
														? chainId && (
																<span style={{ color: '#baff00' }}>
								...
								<div className="flat-search-btn flex">
									...
									{accountid ? (
										<div>
											<a onClick={() => setModalShow(true)}>
												<span className="fs-16 user-data">
													...
													<img
														className="avatar-header mg-l-8"
														src="/assets/images/icon_default.svg"
														alt=""
													/>
												</span>
											</a>
										...
										<div className="sc-btn-top mg-r-12" id="site-header">
											<button
												onClick={() => onConnect()}
												className="button--primary header-slider style style-1 wallet fl-button pri-1"
											>
			...
			<DarkMode />
			<Modal show={modalShow} onHide={onHideModal}>
					...
					<div className="" id="header_admin">
						<div className="header_avatar">
							...
							<div className="avatar_popup mt-20">
								<div className="d-flex align-items-center copy-text justify-content-between"></div>
